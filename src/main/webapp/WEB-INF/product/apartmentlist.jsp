			...
			<!-- 검색 옵션 -->
				...
				<div class="search-option3">
				 	 ...
				 	 <c:forEach var="i" begin="1" end="25">
				 		<img id="gu${i }" src="../resources/img/map/gu_${i }_off.png" class="images" data-value="${i }" @click="mapFindApart(${i })">
				 	 </c:forEach>
				</div>		
	    ...
	    new Vue({
	    	...
	    	methods:{
	    		apartmentlistData:function(page){
	    			...
	    			axios.post("http://localhost:8080/web/product/apartmentlist_vue.do",JSON.stringify(data),{
	    				headers: {
